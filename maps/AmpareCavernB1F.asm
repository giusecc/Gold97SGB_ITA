...
AmpareCavernB1F_MapEvents:
	...
	object_event  8, 30, SPRITE_GROWLITHE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RaikouEvent, EVENT_RAIKOU_APPEARS
	object_event  2,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RouteU6UMaxElixer, EVENT_ROUTE_U6U_MAX_ELIXER
