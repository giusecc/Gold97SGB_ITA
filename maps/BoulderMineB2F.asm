...
BoulderMineB2FHiddenXDefend:
	hiddenitem X_DEFEND, EVENT_BOULDER_MINE_B2F_HIDDEN_X_DEFEND
...
RockTunnelWhitneyText:
	text "CHIARA: Ciao! Sono"
	line "CHIARA, CAPOPALE-"
	cont "STRA di TECNOPOLI."
	para "Dicono ci sia"
	line "una ragazzina che"
	para "si è perduta qui"
	line "da qualche parte."
	para "Sto facendo di"
	line "tutto per"
	cont "trovarla."
	para "Portarla al sicuro"
	line "è più importante"
	para "della PALESTRA al"
	line "momento."
	done
...
BoulderMineB2F_MapEvents:
	...
	object_event 16, 16, SPRITE_BOULDER, SPRITEMOVEDATA_STRENGTH_BOULDER, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BoulderMineB2FBoulder, -1
	object_event 15,  1, SPRITE_WHITNEY, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, RockTunnelWhitneyScript, EVENT_BOULDER_MINE_WHITNEY
