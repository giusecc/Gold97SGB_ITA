...
TeamRocketShipBase_MapEvents:
	...
	object_event  1, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, TeamRocketShipBaseAmuletCoin, EVENT_ALLOY_LIGHTHOUSE_6F_SUPER_POTION
