	...
	const MAGMASHAFTB2F_BOULDER1
	const MAGMASHAFTB2F_BOULDER2
	const MAGMASHAFTB2F_BOULDER3
	const MAGMASHAFTB2F_BOULDER4
	const MAGMASHAFTB2F_POKE_BALL1
	const MAGMASHAFTB2F_POKE_BALL2
...
MagmaShaftB2F_MapEvents:
	...
	warp_event  5, 29, MAGMA_SHAFT_1F, 3
